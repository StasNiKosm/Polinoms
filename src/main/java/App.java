...
public class App {
    ...
    public static void main(String[] args) {
       // ParsingPolynomial.parsingPolynomal("7x+8x");
      ...
      //  List<Monomial> monomialsA = ParsingPolynomial.parsingPolynomal(readerA.read());
      //  Reader readerB = new Reader("C:\\Users\\admin\\.IntelliJIdea2018.3\\config\\scratches\\scratch_1.txt");
      //  List<Monomial> monomialsB = ParsingPolynomial.parsingPolynomal(readerB.read());
